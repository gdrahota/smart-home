...
export default class {
  ...
  addDeviceToLine (ID, name, description, comment, address, serialNumber, applicationProgramLoaded,
                   ...
                   productReferenceId, hardware2ProgramReferenceId, isCommunicationObjectVisibilityCalculated, lastUsedAPDULength,
                   maxReadAPDULength) {
  ...
  addCommunicationReferenceToDevice (text, description, referenceID, datapointType, readFlag, transmitFlag, updateFlag, writeFlag, priority,
                                     isActive, channelID) {
  ...
  addEntryToProductLookupTable (ID, name, busCurrent, serialNumber, isAccessory, isPowerSupply, isChoke, isCoupler, isPowerLineRepeater,
                                isPowerLineSignalFilter, isCable, isIPEnabled, hasApplicationProgram1, hasApplicationProblem2,
  ...
  addEntryToApplicationProgramLookupTable (applicationID, applicationName, applicationNumber, applicationVersion, applicationProgramType,
                                           maskVersion, manufacturerRefID) {
